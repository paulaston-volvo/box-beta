...
void loop() {
  ...
  /*// The GPRS turns off spontaneously
  // turn GPRS on
  while(!fona.enableGPRS(true)) {
    fona.enableGPRS(false);
      Serial.println(("Failed to turn on GPRS. Trying again..."));
  ...
  switch (command) {
    ...
    case 's': {
        ...
        char sendto[]="883510000000091", message[141]="paul.aston@humblebee.se";
        flushSerial();
    ...
    case 'w': {
        ...
        char url[]="http://wifitest.adafruit.com/testwifi/index.html";
    ...
    case 'W': {
        ...
        root["thingId"] = "1";
        //root["timestamp"] = "2019-02-18T14:26:57.369Z";
        root["batteryStatus"] = 3.7;
        root["intemp"] = 20.1;
        root["outtemp"] = 25.1;
        root["lidOpen"] = true;
        root["loaded"] = true;
        ...
        //char data[142]="{\"thingId\":\"001\",\"timestamp\":\"2019-02-18T14:26:57.369Z\",\"batteryStatus\":0,\"intemp\":0,\"outtemp\":0,\"lid\":\"string\",\"load\":\"string\"}";
        //char data[17]="{\"test\":\"yes\"}";
        flushSerial();
